...
public class KotlinMetaFieldGenerator {
  public String generateMetaFields(final List<Data> rosettaClasses, final Iterable<RosettaMetaType> metaTypes, final String version) {
    ...
    final Function1<ExpandedAttribute, Boolean> _function_1 = new Function1<ExpandedAttribute, Boolean>() {
      @Override
      public Boolean apply(final ExpandedAttribute it) {
        return Boolean.valueOf((it.hasMetas() && IterableExtensions.<ExpandedAttribute>exists(it.getMetas(), new Function1<ExpandedAttribute, Boolean>() {
          @Override
          public Boolean apply(final ExpandedAttribute it) {
    ...
    final Function1<ExpandedAttribute, ExpandedType> _function_2 = new Function1<ExpandedAttribute, ExpandedType>() {
      @Override
      public ExpandedType apply(final ExpandedAttribute it) {
        return it.getType();
      }
    };
    ...
    final Function1<Data, List<ExpandedAttribute>> _function_3 = new Function1<Data, List<ExpandedAttribute>>() {
      @Override
      public List<ExpandedAttribute> apply(final Data it) {
        return RosettaAttributeExtensions.getExpandedAttributes(it);
      }
    };
    final Function1<ExpandedAttribute, Boolean> _function_4 = new Function1<ExpandedAttribute, Boolean>() {
      @Override
      public Boolean apply(final ExpandedAttribute it) {
        return Boolean.valueOf((it.hasMetas() && (!IterableExtensions.<ExpandedAttribute>exists(it.getMetas(), new Function1<ExpandedAttribute, Boolean>() {
          @Override
    ...
    final Function1<ExpandedAttribute, ExpandedType> _function_5 = new Function1<ExpandedAttribute, ExpandedType>() {
      @Override
      public ExpandedType apply(final ExpandedAttribute it) {
        return it.getType();
      }
    ...
    final Function1<RosettaMetaType, Boolean> _function_6 = new Function1<RosettaMetaType, Boolean>() {
      @Override
      public Boolean apply(final RosettaMetaType t) {
  ...
  private CharSequence genMetaFields(final Iterable<RosettaMetaType> types, final String version) {
    ...
    {
      final Function<RosettaMetaType, String> _function = new Function<RosettaMetaType, String>() {
        @Override
        public String apply(final RosettaMetaType t) {
